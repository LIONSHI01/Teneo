...
async def main():
    ...
    "origin": "herond-extension://emcclcoaglgcpoognfiggmhnhgabppkm",
    "priority": "high",
    "sec-ch-ua": '"Herond";v="130", "Chromium";v="130", "Not?A_Brand";v="99"', 
    "sec-ch-ua-mobile": "?0",
    "sec-ch-ua-platform": '"Windows"',
    "sec-fetch-dest": "empty",
    "sec-fetch-mode": "cors",
    "sec-fetch-site": "cross-site",
    "user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Herond/130.0.0.0 Chrome/130.0.0.0 Safari/537.36", 
